...
#RESOLUTION = (960, 468)
RESOLUTION = (960, 668)     # This is the resolution of the 7" TFT screen
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
PADDLE_HEIGHT = 60
PADDLE_WIDTH = 14
...
for arg in sys.argv:
    if arg == "--help" or arg=="-h":
        print "\nOptions are:\n --resizeable  to display in a window mode.  Thanks!\n\n"
        os._exit(0)
    if arg == "--resizeable":
...
def main():
    ...
    game_ball = Ball(ball_pos, ball_paddles, (12.0, 8.0), SCREEN, play_area)
